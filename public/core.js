...
//                    data[i].title = $sce.trustAsHtml('<strong>' + titleHtml + </strong>)
    ...
    $scope.getBackgroundColor = function(index) {
        ...
        if(index == 1) {
            return {'color':'#E0F7FA', 'font-family': 'Microsoft Yahei', 'font-size':'20px'};
        }
        if(index == 2) {
            return {'color':'#80DEEA', 'font-family': 'Microsoft Yahei', 'font-size':'20px'};
        }
        if(index == 3) {
            return {'color':'#26C6DA', 'font-family': 'Microsoft Yahei', 'font-size':'20px'};
        }
        if(index == 4) {
            return {'color':'#00ACC1', 'font-family': 'Microsoft Yahei', 'font-size':'20px'};
        }
        if(index == 5){
            return {'color':'#00838F', 'font-family': 'Microsoft Yahei', 'font-size':'20px'}; 
        }
    };
